<x-app-layout>
    ...
    <div class="py-12">
        ...
        <form action="{{ route('song.store') }}" class="mt-4" method="post">
            @csrf
            <div class="mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900">Nombre</label>
                <input type="text" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('nombre')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="artista" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('artista')
                    <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
